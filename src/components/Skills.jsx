export default function Skills() {
  const skills = [
    ...
    { name: "MongoDB", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg", level: 60 }
  ];
  ...
  return (
    <section id="skills" className="pt-32 p-16 bg-gray-900 text-white ">
      ...
      <h2 className="text-4xl font-bold  text-orange-400 mb-5 "><span className="text-gray-500">My</span> Skills</h2>
    ...
    <div className=" border-black/60 w-full md:w-1/2 p-2  shadow-2xl shadow-black/60  hover:shadow-gray-500/10 transition-all ">
     <div className="bg-slate-950 p-10">
        <p className="text-center max-w-2xl mx-auto mt-4 text-gray-300 leading-relaxed">
          "I specialize in crafting modern, high-performance web applications with a seamless user experience. 
          From front-end interfaces to back-end functionality, I bring ideas to life using the latest technologies."
        </p>

        <ul className="mt-6 space-y-3 text-gray-200 text-lg">
          <li>✅ <strong>Front-End Development:</strong> React.js, JavaScript, Tailwind CSS, HTML/CSS</li>
          <li>✅ <strong>Back-End Development:</strong> Node.js, Express.js, MongoDB</li>
          <li>✅ <strong>Version Control & Deployment:</strong> Git, GitHub</li>
        </ul>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 place-items-center  ">
        {skills.map((skill, index) => (
          <div key={index} className="relative w-48 h-48 bg-slate-950  rounded-xl shadow-2xl flex flex-col items-center justify-center p-5
            ...
            {/* Progress Bar */}
            <div className="w-full mt-3 bg-gray-700 rounded-full h-2 " style={{boxShadow:"0px 0px 2px 1px gray" }}>
              <div 
                className="h-2 rounded-full transition-all duration-1000 ease-in-out"
                style={{ width: `${skill.level}%`, backgroundColor: skill.level > 80 ? '#22c55e' : skill.level > 65 ? '#eab308' : '#f43f5e', boxShadow:"0px 0px 2px 1px"}} 
              ></div>
            </div>
